namespace Honoo.BouncyCastle
{
    ...
    public enum SymmetricCipherMode
    {
        ...
        /// <br/>This cipher mode can only select <see cref="SymmetricPaddingMode.NoPadding" /> padding mode.
        /// <br/>BUG: GCM cipher mode cannot be auto reused. The cipher instance needs to be recreated every time. (BouncyCastle 1.9.0 has not been fixed).
        /// </summary>
        GCM,
        ...
        /// <br/>This cipher mode can only select <see cref="SymmetricPaddingMode.NoPadding" /> padding mode.
        /// <br/>BUG: OCB cipher mode supported null(0) Nonce/IV size but BouncyCastle cannot set that. (BouncyCastle 1.9.0 has not been fixed).
        /// </summary>
        OCB,
    }
}