...
namespace Honoo.BouncyCastle
{
    ...
    public sealed class AsymmetricAlgorithmName : IEquatable<AsymmetricAlgorithmName>
    {
        ...
        internal delegate AsymmetricAlgorithm GenerateAlgorithmCallback();
        ...
        internal AsymmetricAlgorithmName(string name, AsymmetricAlgorithmKind kind, GenerateAlgorithmCallback generateAlgorithm)
        {
            _name = name;
            _kind = kind;
