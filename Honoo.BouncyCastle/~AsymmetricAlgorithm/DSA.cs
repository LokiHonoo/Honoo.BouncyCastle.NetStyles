...
namespace Honoo.BouncyCastle
{
    ...
    public sealed class DSA : AsymmetricAlgorithm
    {
        ...
        private static readonly KeySizes[] _legalKeySizes = new KeySizes[] { new KeySizes(512, 1024, 64) };
        ...
        /// Gets key size bits.
        /// </summary>
        public int KeySize => _keySize == 0 ? 1024 : _keySize;
        ...
        public void GenerateKeyPair(int keySize = 1024, int certainty = 80)
        {
